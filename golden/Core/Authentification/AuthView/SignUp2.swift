                    ...
                    .ignoresSafeArea()
                        ...
                        VStack(alignment: .leading) { // Align text to the leading edge
                            ...
                            VStack(alignment: .center) { // Center non-text elements
                                ...
                                NavigationLink(destination: SignUp4().navigationBarBackButtonHidden(true)) { // Navigate to SignUp2
                                    Text("Continue")
                                ...
                                NavigationLink(destination: SignUp1().navigationBarBackButtonHidden(true)) { // Navigate to SignUp2
                                    Text("Back to Step 1")
